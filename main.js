define(function (require, exports, module) {
	...
	function compileCoffee(content, documentPath) {
		...
		$.when(connectToNodeModule("CoffeeCompiler"), loadFilesToCompile(preferences.compilePath, documentPath)).then(function (compiler, files) {
